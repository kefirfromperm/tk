...
<c:set var="fontColor" value="${param['font-color']}"/>
<c:if test="${fontColor==null}"><c:set var="fontColor" value="#000000"/></c:if>
<c:set var="backgroundColor" value="${param['background-color']}"/>
...
<div id="form">
    <form action="<c:url value="/twit"/>" method="post">
        ...
        <textarea rows="8" cols="60" id="message" name="message" style="color: ${fontColor};background-color: ${backgroundColor};"><c:out value="${param.message}"/></textarea>
